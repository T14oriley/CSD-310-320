...
public class RockPaperScissors
{
  ...
  //Methods for rock, paper, and scissor are set for static and final. Static is to allow
  //the variables to be called in any method without global keywords, and final
  //is to ensure the variables cannot change.
